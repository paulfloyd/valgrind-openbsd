...
/*--------------------------------------------------------------------*/
/*--- OpenBSD-specific kernel interface.             vki-openbsd.h ---*/
/*--------------------------------------------------------------------*/
...
#ifndef VKI_OPENBSD_H
#define VKI_OPENBSD_H
...
#if defined(VGA_x86)
#  include "vki-machine-types-x86-openbsd.h"
#elif defined(VGA_amd64)
#  include "vki-machine-types-amd64-openbsd.h"
#else
...
typedef  vki_uint32_t   __vki_mode_t;
typedef  vki_uint32_t   __vki_nlink_t;
...
#if defined(VGA_x86)
#  include "vki-x86-openbsd.h"
#elif defined(VGA_amd64)
#  include "vki-amd64-openbsd.h"
#else
#  error Unknown platform
#endif

//----------------------------------------------------------------------
// openbsd version hacks
//----------------------------------------------------------------------
#ifndef ELFMAG
...
#define VKI_SA_RESTORER         0 /* OpenBSD doesn't have this */
...
#define VKI_OPENBSD11_MNAMELEN   88

struct vki_openbsd11_statfs {
   ...
   char      f_mntfromname[VKI_OPENBSD11_MNAMELEN];
   char      f_mntonname[VKI_OPENBSD11_MNAMELEN];
};
...
#define _VKI_IOC_NRBITS    8U  /* "num" on openbsd */
#define _VKI_IOC_TYPEBITS  8U  /* "group" on openbsd */
...
#define _VKI_IOC_NONE   1U /* "void" on openbsd, as a specific mode */
...
// See syswrap-openbsd.c PRE/POST(sys_ioctl)
#if 0
//----------------------------------------------------------------------
// From net/if.h
//----------------------------------------------------------------------
...
#define VKI_KVE_ET_OBJ			0x00000001
#define VKI_KVE_ET_SUBMAP		0x00000002
#define VKI_KVE_ET_COPYONWRITE	 	0x00000004
#define VKI_KVE_ET_NEEDSCOPY		0x00000008
#define VKI_KVE_ET_HOLE			0x00000010
#define VKI_KVE_ET_NOFAULT		0x00000020
#define VKI_KVE_ET_STACK		0x00000040
#define VKI_KVE_ET_WC			0x00000080
#define VKI_KVE_ET_CONCEAL		0x00000100
#define VKI_KVE_ET_SYSCALL		0x00000200
#define VKI_KVE_ET_FREEMAPPED		0x00000800

#define VKI_KVE_PROT_NONE		0x00000000
#define VKI_KVE_PROT_READ		0x00000001
#define VKI_KVE_PROT_WRITE		0x00000002
#define VKI_KVE_PROT_EXEC		0x00000004

#define VKI_KVE_ADV_NORMAL		0x00000000
#define VKI_KVE_ADV_RANDOM		0x00000001
#define VKI_KVE_ADV_SEQUENTIAL		0x00000002

#define VKI_KVE_INH_SHARE		0x00000000
#define VKI_KVE_INH_COPY		0x00000010
#define VKI_KVE_INH_NONE		0x00000020
#define VKI_KVE_INH_ZERO		0x00000030

#define VKI_KVE_F_STATIC		0x01
#define VKI_KVE_F_KMEM			0x02
...
struct vki_kinfo_file {
   ...
   union {
      struct {
         /* API compatiblity with OpenBSD < 12. */
      ...
      union {
         ...
         struct {
            ...
            /* Vnode filesystem id, OpenBSD 11 compat. */
            vki_uint32_t	vki_kf_file_fsid_openbsd11;
            /* File device, OpenBSD 11 compat. */
            vki_uint32_t	kf_file_rdev_openbsd11;
            /* File mode. */
         ...
         struct {
            vki_uint32_t	vki_kf_spareint[4];
            vki_uint64_t	vki_kf_spareint64[32];
            vki_uint32_t	vki_kf_pts_dev_openbsd11;
...
/* AT_COUNT depends on the OpenBSD version, not currently used */


#define VKI_NT_OPENBSD_ABI_TAG 1
#define VKI_NT_OPENBSD_FEATURE_CTL	4
#define VKI_NT_OPENBSD_FCTL_WXNEEDED	0x00000008
